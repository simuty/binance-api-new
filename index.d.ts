...
declare module 'binance-api-new' {
  ...
  export interface Binance {
    ...
    getUserAsset(options?: { recvWindow?: number }): Promise<getUserAsset[]>
    ...
    futuresAllBookTickers(options?: {
      symbol?: string
    }): Promise<{ [key: string]: Ticker }>
